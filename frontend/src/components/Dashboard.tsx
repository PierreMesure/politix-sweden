        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200 dark:divide-zinc-800">
            <thead className="bg-gray-50 dark:bg-zinc-950">
              <tr>
                <th className="pl-2 pr-1 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Name</th>
                <th className="px-1 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Party</th>
                <th className="px-1 py-3 text-center lg:text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                  <span className="hidden lg:inline">Bluesky</span>
                ...
                <th className="px-1 py-3 text-center lg:text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">
                  <span className="hidden lg:inline">Mastodon</span>
                  <div className="lg:hidden flex justify-center">
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                ...
                <th className="pl-1 pr-2 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Edit</th>
              </tr>
            </thead>
                ...
                filteredPoliticians.map((p) => (
                  ...
                  <td className="px-1 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400 max-w-[80px] truncate">
                    {p.party && PARTY_LOGOS[p.party] ? (
                      ...
                      <span title={p.party || "Unknown"}>{p.party || "Unknown"}</span>
                    )}
                  </td>
                    ...
                    {p.social.bluesky ? (
                      <div className="flex flex-col items-center lg:items-start">
                        ...
                        <div className="flex items-center gap-1.5 mt-1">
                          <span className={`w-2 h-2 rounded-full ${isActive(p.social.bluesky.last_post) ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600'}`} title={isActive(p.social.bluesky.last_post) ? 'Active recently' : 'Inactive'}></span>
                  ...
                  <td className="px-1 py-4 whitespace-nowrap text-sm">
                    {p.social.mastodon ? (
                      <div className="flex flex-col items-center lg:items-start">
                        ...
                        <div className="flex items-center gap-1.5 mt-1">
                          <span className={`w-2 h-2 rounded-full ${isActive(p.social.mastodon.last_post) ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600'}`} title={isActive(p.social.mastodon.last_post) ? 'Active recently' : 'Inactive'}></span>
                    ...
                    {p.social.x ? (
                      ...
                      <span className="text-gray-300 dark:text-zinc-700 flex justify-center lg:justify-start">-</span>
                                    ...
                                    <td className="pl-1 pr-2 py-4 whitespace-nowrap text-sm">
                                      ...
                                      >
                                        <span className="hidden lg:inline">Edit on Wikidata</span>
